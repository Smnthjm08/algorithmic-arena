   ...
   return (
     <section className="bg-white dark:bg-gray-900 bg-gradient-to-t dark:from-[#020817] dark:to-[#0F172A] py-10 md:py-16">
       <div className="flex flex-col items-center text-center gap-4">
         ...
         <div className="text-sm text-gray-500 w-full md:w-1/3 mx-auto">
           Solve problems in your preferred language with Algorithmic Arena, offering a wide range of programming language options.
         </div>
         <div className="flex flex-wrap gap-4 justify-center bg-gray-100 dark:bg-black rounded-md p-2">
           {languages.map((lang, index) => (
             <img key={index} src={`/languagesIcon/${lang}`} alt="language icon" className="w-12 h-12 object-contain" />
           ))}
         </div>
         <div className="text-sm text-gray-500 mt-4"> & Many More </div>
       </div>
     </section>
   );
 }
